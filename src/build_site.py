...
body{margin:0;background:var(--paper);color:var(--ink);font-family:Georgia,'Times New Roman',serif;line-height:1.65;-webkit-font-smoothing:antialiased;overflow-wrap:break-word;word-break:break-word;-webkit-text-size-adjust:100%}
...
pre.code{background:#1c1a17;color:#f3ede0;border-radius:5px;padding:14px 16px;overflow-x:auto;font-size:14px;white-space:pre-wrap;word-break:break-word;
...
.links a{display:block;margin:6px 0;font-weight:700;overflow-wrap:anywhere;word-break:break-word}
